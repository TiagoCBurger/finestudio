...
const title = 'Welcome to Fine Studio!';
const description =
  "Fine Studio is a platform for creating and sharing AI-powered projects. Let's get started by creating a flow, together.";
